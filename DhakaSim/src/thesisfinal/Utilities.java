...
class Utilities {
    ...
    // Method to calculate the cumulative distribution function (CDF) for a Gaussian
    // distribution
    ...
    protected static double getRandomFromMultipleGaussianDistributionOfObjectsBlockage(int objectType) {
        ...
        // For each possible integer return value, subtract yourFunction value for that
        // possible return value till you get below 0. Once you get below 0, return the
        // current value.
    ...
    static thesisfinal.Point2D getNewEndPointForIntersectionStrip(Vehicle vehicle, IntersectionStrip is,
            int newStripIndex) {
        ...
        double dist1 = (x_3 - vehicle.getSegEndX() * Parameters.pixelPerMeter)
                * (x_3 - vehicle.getSegEndX() * Parameters.pixelPerMeter)
                + (y_3 - vehicle.getSegEndY() * Parameters.pixelPerMeter)
                        * (y_3 - vehicle.getSegEndY() * Parameters.pixelPerMeter);
        double dist2 = (x_4 - vehicle.getSegEndX() * Parameters.pixelPerMeter)
    ...
    static void initialize() {
        try {
            BufferedReader bufferedReader = new BufferedReader(
                    new FileReader(new File("D:\\DhakaSim-latest\\DhakaSim\\input\\parameter.txt")));
            while (true) {
                ...
                switch (name) {
                    ...
                    case "SignalChangeDuration":
                        ...
                        Parameters.SIGNAL_CHANGE_DURATION = (int) (round(
                    ...
                    case "CF_model":
                        ...
                        switch (p) {
                            ...
                            case 2 -> Parameters.car_following_model = Parameters.CAR_FOLLOWING_MODEL.GIPPS_MODEL; // no
                                                                                                                   // collision
                            case 3 -> Parameters.car_following_model = Parameters.CAR_FOLLOWING_MODEL.KRAUSS_MODEL; // 100700+
                                                                                                                    // //OK
                            case 4 -> Parameters.car_following_model = Parameters.CAR_FOLLOWING_MODEL.GFM_MODEL; // no
                                                                                                                 // collision
                            case 5 -> Parameters.car_following_model = Parameters.CAR_FOLLOWING_MODEL.IDM_MODEL; // 61021
                                                                                                                 // //OK
                            ...
                            case 8 -> Parameters.car_following_model = Parameters.CAR_FOLLOWING_MODEL.OVCM_MODEL; // no
                                                                                                                  // collision
                                                                                                                  // (1s->time
                                                                                                                  // step)
                                                                                                                  // 15577
                            ...
                            case 12 -> Parameters.car_following_model = Parameters.CAR_FOLLOWING_MODEL.MY_MODEL; // no
                                                                                                                 // collision
                    ...
                    case "AcrossPedestrianPerHour":
                        Parameters.ACROSS_PEDESTRIAN_PER_HOUR = Integer.parseInt(value);
                        break;
            ...
            assert (round(Parameters.slowVehiclePercentage + Parameters.mediumVehiclePercentage
                    + Parameters.fastVehiclePercentage) == 100.0);
