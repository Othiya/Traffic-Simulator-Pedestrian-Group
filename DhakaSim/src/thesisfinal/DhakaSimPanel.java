...
public class DhakaSimPanel extends JPanel
    ...
    public DhakaSimPanel(JFrame jFrame) {
        ...
        try {
            if (Parameters.TRACE_MODE) {
                ...
                traceWriter.write(Parameters.simulationSpeed + " " + Parameters.simulationEndTime + " "
                        + Parameters.acrossPedestrianMode);
                traceWriter.newLine();
                traceWriter.flush();
            }
        ...
        if (Parameters.TRACE_MODE) {
            ...
            if (Parameters.acrossPedestrianMode) {
                ...
                for (Pedestrian pedestrian : pedestrians) {
                    pedestrian.drawMobilePedestrian(traceWriter, g2d, Parameters.pixelPerStrip,
                            Parameters.pixelPerMeter, Parameters.pixelPerFootpathStrip);
                }
            }
            try {
            ...
            for (Vehicle vehicle : vehicleList) {
                vehicle.drawVehicle(traceWriter, g2d, Parameters.pixelPerStrip, Parameters.pixelPerMeter,
                        Parameters.pixelPerFootpathStrip);
            }
            ...
            for (Object object : objectList) {
                object.drawObject(traceWriter, g2d, Parameters.pixelPerStrip, Parameters.pixelPerMeter,
                        Parameters.pixelPerFootpathStrip);
            }
    ...
    private void drawNodeId(Graphics2D g2d, Node node) {
        ...
        g2d.drawString(Integer.toString(node.getId()), (int) (node.x * Parameters.pixelPerMeter),
                (int) (node.y * Parameters.pixelPerMeter));
    ...
    private void drawRoadNetwork(Graphics2D g2d) {
        ...
        for (Node node : nodeList) {
            ...
            for (int j = 0; j < node.numberOfLinks(); j++) {
                ...
                if (link.getUpNode() == node.getId()) {
                    ...
                    // double width = 2 * pixelPerFootpathStrip +
                    // (link.getSegment(0).numberOfStrips() - 2) * pixelPerStrip;
                    ...
                    // double w = 2 * pixelPerFootpathStrip +
                    // (link.getSegment(link.getNumberOfSegments() - 1).numberOfStrips() - 2) *
                    // pixelPerStrip;
                ...
                for (int k = 0; k < node.numberOfLinks(); k++) {
                    if (j != k) {
                        ...
                        if (linkPrime.getUpNode() == node.getId()) {
                            ...
                            // double w = 2 * pixelPerFootpathStrip +
                            // (linkPrime.getSegment(0).numberOfStrips() - 2) * pixelPerStrip;
                            ...
                            // double w = 2 * pixelPerFootpathStrip +
                            // (linkPrime.getSegment(linkPrime.getNumberOfSegments() - 1).numberOfStrips() -
                            // 2) * pixelPerStrip;
        ...
        for (Link link : linkList) {
            ...
            for (int j = 1; j < link.getNumberOfSegments(); j++) {
                ...
                // double w = 2 * pixelPerFootpathStrip + (segment.numberOfStrips() - 2) *
                // pixelPerStrip;
                ...
                // double wPrime = 2 * pixelPerFootpathStrip +
                // (link.getSegment(j).numberOfStrips() - 2) * pixelPerStrip;
